...
| 用途 | 字體 |
|---|---|
| 中文標題（h1/h2/h3） | Noto Serif TC |
| 中文內文 | Noto Sans TC |
| 英文／數字 | DM Sans |
| 導覽列 | DM Sans + Noto Sans TC |

**Google Fonts 引入：**
```html
<link href="https://fonts.googleapis.com/css2?family=Noto+Serif+TC:wght@400;500&family=Noto+Sans+TC:wght@400;500&family=DM+Sans:wght@400;500&display=swap" rel="stylesheet">
```
...
### 案例分享
- 卡片上方：16:9 佔位圖，點擊燈箱顯示實際照片
- 無分類 Tab 篩選

| 專案 | 標籤 | 燈箱圖片 |
|---|---|---|
| MIT 微笑標章社群行銷 | 社群行銷、內容企劃 | MIT_社群貼文_社團體驗.png、MIT_社群貼文_廠商推廣.png、MIT_社群貼文_KOC合作.png |
| 實體活動企劃執行 | PM、社群行銷 | 實體活動企劃執行_大甲媽祖遶境.png、實體活動企劃執行_超級悠遊卡記者會.png、實體活動企劃執行_落成典禮.png、實體活動企劃執行_輪動台灣.png |
| T 客邦實體課程開發 | PM、內容企劃 | T客邦課程_社群推廣.png、T客邦課程_課程推廣.png |
| 跨部門大型活動協作 | PM | 跨部門大型活動協作_科技金獎.png、跨部門大型活動協作_通訊大賽.png、跨部門大型活動協作_黑客松.png |
